...
def main():
    files = [
        "/Users/lehoangan/Downloads/merge_b/drive-download-20260731T041851Z-1-001/merged/collision_params_resolved.json",
        "/Users/lehoangan/Downloads/merge_L/merged/collision_params_resolved.json",
        "/Users/lehoangan/Downloads/merge_d/merged/collision_params_resolved.json"
    ]
    ...
    for path in files:
        ...
        print(f"{os.path.basename(path)} -> ColObj: {np.mean(col_objs):.4f}")
